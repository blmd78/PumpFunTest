...
const CreateToken: React.FC = () => {
  ...
  const [showPreventNavigationModal, setShowPreventNavigationModal] =
    useState(false);
  ...
  return (
    <Layout>
      <SEO
        title="Create Your Own Token - likeaser"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form
          ...
          className="space-y-6 bg-[#3F3F5D] p-4 sm:p-6 rounded-lg shadow-xl"
        >
          {/* Token Name and Symbol inputs */}
          <h1 className="text-xl sm:text-1xl md:text-2xl font-bold text-[#F9F9F9] mb-6 text-center">
            Create Token
          </h1>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label
                htmlFor="tokenName"
                className="block text-[10px] sm:text-xs font-medium text-[#F9F9F9] mb-1"
              >
                Token Name
              </label>
              <input
                ...
                required
                className="w-full py-2 px-3 bg-[#D9D9D9] border rounded-md text-[#1B1B28] focus:outline-none focus:ring-2 focus:ring-[#5252FF] focus:border-[#5252FF] transition duration-150 ease-in-out"
          ...
          <div>
            <label
              htmlFor="tokenImage"
              className="block text-[10px] sm:text-xs font-medium text-[#F9F9F9] mb-2"
            >
              Token Image
            </label>
            <div
              className="mt-1 flex justify-center items-center px-4 py-4 border-2 border-dashed rounded-md hover:border-[#5252FF] transition duration-150 ease-in-out"
            ...
            >
              <div className="space-y-1 text-center">
                <div className="flex flex-col items-center">
                  <label
                    htmlFor="tokenImage"
                    className="flex cursor-pointer bg-[#D9D9D9] rounded-md font-medium text-[#5252FF] hover:bg-[#1E1E59] border hover:border-[#5252FF] focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500 transition duration-150 ease-in-out px-3 py-2 mb-2 sm:mb-0 sm:mr-2"
                  >
                    <CloudArrowUpIcon className="mx-auto h-6 w-6 text-[5252FF] mr-2" />
                  ...
                  <div className="flex flex-col sm:flex-row text-[9px] sm:text-sm text-[#F9F9F9] mt-2 items-center">
                    <p>or drag and drop PNG, JPG, GIF up to 1MB</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 flex justify-center">
              <div className="text-center">
                <img
                  src={tokenImageUrl}
                  alt="Token preview"
                  className="h-24 w-24 object-cover rounded-full mx-auto border-2 border-[#5252FF]"
                />
              </div>
            </div>
          )}
          ...
          <div className="border rounded-md overflow-hidden">
            <button
              ...
              className="w-full flex justify-between items-center p-3 bg-[#D9D9D9] text-[#1B1B28] hover:bg-[#B0B0B0] transition-colors duration-200"
            >
            ...
            {isSocialExpanded && (
              <div className="p-4 bg-[#3F3F5D] grid grid-cols-1 sm:grid-cols-2 gap-4 text-[10px] sm:text-xs">
                {[
                  {
                    id: "website",
                    label: "Website",
                  ...
                  <div key={item.id}>
                    ...
                    {/* <input
                      ...
                      className="w-full py-2 px-3 bg-[#D9D9D9] border rounded-md text-[#1B1B28] placeholder:text-[6px] focus:outline-none focus:ring-2  focus:ring-[#5252FF] focus:border-[#5252FF] transition duration-150 ease-in-out"
                    ...
                    <input
                      ...
                      value={item.value}
                      onChange={(e) => item.setter(e.target.value)}
                      className="w-full py-2 px-3 bg-[#D9D9D9] border rounded-md text-[#1B1B28] placeholder:text-xs focus:outline-none focus:ring-2 focus:ring-[#5252FF] focus:border-[#5252FF] transition duration-150 ease-in-out"
                      placeholder="optional"
                    />
                  </div>
                ))}
          ...
          <div className="flex justify-center">
            <button
              ...
              className={`w-fit py-3 px-4 border border-transparent rounded-full shadow-sm text-xs sm:text-sm font-medium text-[#F9F9F9] transition duration-150 ease-in-out ${
                isButtonDisabled
                  ? "bg-[#1B1B28] cursor-not-allowed"
                  : "bg-[#5252FF] hover:bg-[#333391] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#5252FF]"
              }`}
            >
              {getButtonText()}
            </button>
          ...
          >
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500">
                Your token is being{" "}
                {creationStep === "creating" ? "created" : "updated"}. This
                process may take a few moments. Please do not navigate away or
                close the browser until the process is complete.
              </p>
            </div>
          </Modal>
        )}
