  ...
  return (
    <div {...props} className="flex">
      ...
      <div className="relative group lg:mr-4 mr-auto">
        ...
        >
          ...
          <div
            ...
            } bg-white text-[16px] leading-[22px] font-bold text-[#F7931A] text-center text-xs rounded-3xl whitespace-nowrap bottom-full left-1/2 transform -translate-x-1/2`}
          >
      ...
      <div className="relative mr-auto">
        ...
        {/* "Soon" Text */}
        {showSoon && (
          <div className="absolute left-1/2 transform -translate-x-1/2 bottom-full mb-2 bg-white text-[#F7931A] text-sm font-bold px-3 py-1 rounded-lg">
            Soon
          </div>
        )}
      </div>
    ...
    <div className="bg-[#0B0C0F] border-t border-t-[#C26D06] p-8 relative flex justify-center">
      <div className="flex flex-col w-[1200px]">
        ...
        <div className="lg:hidden block">
          <SocialLinks order={[1]} className="border-b-none pb-0 mb-0" />
          <div className="flex justify-between items-center mt-14"></div>
        </div>
      </div>
    </div>
  );
